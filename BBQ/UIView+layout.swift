...
extension UIView {
    ...
    @discardableResult
    func centerX(_ offset: CGFloat = 0, _ targetV: UIView? = nil) -> UIView {
    ...
    @discardableResult
    func centerY(_ offset: CGFloat = 0, _ targetV: UIView? = nil) -> UIView {
        let target = targetV == nil ? self.superview! : targetV!
    ...
    @discardableResult
    func width(_ width: CGFloat = 0) -> UIView {
        self.widthAnchor.constraint(equalToConstant: width).isActive = true
        return self
    }

    @discardableResult
    func height(_ height: CGFloat = 0) -> UIView {
        self.heightAnchor.constraint(equalToConstant: height).isActive = true
        return self
    }

    @discardableResult
    func widthEqualTo(_ targetV: UIView? = nil, _ multi: CGFloat = 1, _ offset: CGFloat = 0) -> UIView {
        let target = targetV == nil ? self.superview! : targetV!
    ...
    @discardableResult
    func heightEqualTo(_ targetV: UIView? = nil, _ multi: CGFloat = 1, _ offset: CGFloat = 0) -> UIView {
        let target = targetV == nil ? self.superview! : targetV!
    ...
    @discardableResult
    func size(_ width: CGFloat = 0, _ height: CGFloat = 0) -> UIView {
    ...
    @discardableResult
    func bottom(_ offset: CGFloat = 0, _ targetV: UIView? = nil, _ reverse: Bool = false) -> UIView {
        let target = targetV == nil ? self.superview! : targetV!
    ...
    @discardableResult
    func top(_ offset: CGFloat = 0, _ targetV: UIView? = nil, _ reverse: Bool = false) -> UIView {
        let target = targetV == nil ? self.superview! : targetV!
    ...
    @discardableResult
    func left(_ offset: CGFloat = 0, _ targetV: UIView? = nil, _ reverse: Bool = false) -> UIView {
        let target = targetV == nil ? self.superview! : targetV!
    ...
    @discardableResult
    func right(_ offset: CGFloat = 0, _ targetV: UIView? = nil, _ reverse: Bool = false) -> UIView {
        let target = targetV == nil ? self.superview! : targetV!
    ...
    @discardableResult
    func leading(_ offset: CGFloat = 0, _ targetV: UIView? = nil, _ reverse: Bool = false) -> UIView {
        let target = targetV == nil ? self.superview! : targetV!
    ...
    @discardableResult
    func trailing(_ offset: CGFloat = 0, _ targetV: UIView? = nil, _ reverse: Bool = false) -> UIView {
        let target = targetV == nil ? self.superview! : targetV!
